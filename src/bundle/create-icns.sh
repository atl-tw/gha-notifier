#!/bin/bash
# from here: https://gist.github.com/xtrasmal/3b6dd4a13a6ce9c28cdd521df62e20d5
...
# create_icns --create-placeholders or
  #create_icns --create-placeholders-from-image existing-image.png
  # cd icon_images
      #  create_icns --create-icns
